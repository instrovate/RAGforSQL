...
uploaded_file = st.file_uploader("Just Click on Preview Checkbox and run on pre loaded database or Download and Upload any of the above sample db file Or Upload your own SQLite .db file", type=["db"])
if uploaded_file:
    db_path = "uploaded.db"
